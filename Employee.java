public class Employee {
    ...
    public static void main(String[] args) {
        System.out.println("\n      INDIAN Company Employee List");
        Officer officer1 = new Officer("Mannu", 25, 618452462, 32495.5, "Kerala", "HR");
        officer1.printSalary();
        officer1.printSpec();

        Manager manager1 = new Manager("Ammu", 22, 896243139, 89324.1, "Bangalore", "Design");
